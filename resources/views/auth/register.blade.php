...
<body class="flex min-h-screen items-center justify-center bg-gray-50 px-4 font-sans">
    <div class="w-full max-w-md rounded-xl bg-white p-6 text-center shadow-md">
        ...
        <p class="mt-5 text-xs text-gray-500">By clicking continue, you agree to our <a href="#" class="underline">Terms of Service</a> and <a href="#" class="underline">Privacy Policy</a></p>
    </div>
</body>
</html>